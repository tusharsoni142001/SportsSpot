...
<body>
    <div class="container">
        ...
        <main>
                    ...
                    <div class="middle">
                        <div class="left">
                            ...
                            <h1 style="position: absolute;margin: 5px 22px; font-size: 38px;"><?php
                                                                                                include('dbcon.php');
                                                                                                $query = "SELECT count(bookingID) as number FROM booking where userID=" . $_SESSION['userid'];
            ...
            mysqli_stmt_bind_param($stmt, 'iss',$_SESSION['userid'], $start_date, $end_date);
 ...
 <?php
            ...
            $Sportsquery = "SELECT sportsID,COUNT(sportsID) as sportCount from booking where userID=".$_SESSION['userid']." GROUP BY sportsID";
